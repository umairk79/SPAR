  ...
  <body class="mdl-demo mdl-color--grey-100 mdl-color-text--grey-700 mdl-base">
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          <a href="teacherhome.php" class="mdl-layout__tab">Home</a>
           ...
           <div class="mdl-card mdl-cell mdl-cell--12-col">
			...
			<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" style="background-color:white;">
				...
				<div id="remarks">
                    ...
                    <button type="button" class="btn btn-info add" id="addComm" onclick="addComments()">Add Comments</button>
                    
                    <div class="container">
                      <form method="POST" action="update.php">
                        <div class="form-group comm" style="display:none;">
                        ...
                        <button type="submit" class="btn btn-default add comm" style="display:none;" name="submit5">Submit</button>
                      </form>
                    </div>
                </div>
	...
	var allow=0;
	   function addComments() {
           ...
           var elements = document.getElementsByClassName("comm");
